  ...
  return (
    <div id="contact" className="w-full bg-gradient-to-b from-black to-gray-800">
      <div className="max-w-screen-xl mx-auto px-8 py-16 text-center md:text-left">
        ...
        <div className="flex flex-col md:flex-row gap-8 shadow-xl shadow-blue-300  mt-4 bg-gradient-to-b from-black to-gray-800 ">
          <div className="w-full md:w-1/2 h-full rounded-xl p-4">
            ...
            <div className="grid grid-cols-2 mx-auto w-4/5 gap-10">
              <div className="flex bg-blue-500 items-center justify-center rounded-full shadow-md shadow-blue-500 hover:scale-105 duration-200 p-3 cursor-pointer">
              ...
              >
                <div className="grid md:grid-cols-2 gap-4 w-full py-2">
                  <div className="flex flex-col">
                    <label className="capitalize text-sm py-2 text-slate-600 font-light fill-transparent">
                      name
                    </label>
                    <input
                      type="text"
